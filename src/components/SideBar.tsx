      ...
      >
        ...
        <div>
          ...
          <div
            ...
            className="flex flex-col gap-y-3 text-kb-gray font-bold text-[15px] mb-1"
          >
            <div
              className={`${
                dark ? "hover:bg-white" : ""
          ...
          <div
            onClick={() => signOut()}
            className="flex items-center gap-x-3 mb-8 font-bold text-kb-gray group pl-[34px] cursor-pointer rounded-r-full h-[48px] mr-5 hover:bg-kb-red-light/20 transition-all"
          >
            <svg
